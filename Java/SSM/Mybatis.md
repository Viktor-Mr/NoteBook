...
- 持久化就是将程序的数据在<font color='red'>持久状态</font>和<font color='red'>瞬时状态</font>转化的过程
...
mybatis mapper配置文件结果集映射resultMap中

collection属性(一对多关系结果集映射)  和  association属性(多对一关系结果集映射)理解：
...
<select id="queryBlogForeach" parameterType="map" resultType="blog">
    ...
    <where>
        <foreach collection="id	s" item="id" open="and (" close=")" separator="or">
            id = #{id}
        </foreach>
    </where>
